...
coord_dict = {'blue_top_port': (0.0, 0.03646, 0.11111, 0.18519),
              ...
              "blue_top_shutdown" : (0.420,0.450,0.790,0.804),
              "blue_jug_shutdown" : (0.420,0.450,0.831,0.845),
              "blue_mid_shutdown" : (0.420,0.450,0.872,0.885),
              "blue_bot_shutdown" : (0.420,0.450,0.913,0.925),
              "blue_sup_shutdown" : (0.420,0.450,0.954,0.966),
              "red_top_shutdown" : (0.556,0.586,0.790,0.804),
              "red_jug_shutdown" : (0.556,0.586,0.831,0.845),
              "red_mid_shutdown" : (0.556,0.586,0.872,0.885,
              "red_bot_shutdown" : (0.556,0.586,0.913,0.925),
              "red_sup_shutdown" : (0.556,0.586,0.954,0.),
